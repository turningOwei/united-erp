 ...
 * @date 2016-12-17
 */
Ext.define('Module.permission.ResourceQry', {
    ///permission/roleresource/lisResourceByDeptRole.do?corpId=1&&roleId=1
    dataUrl     :  SysConfig.ctx + '/permission/roleresource/lisResourceByDeptRole.do?',
